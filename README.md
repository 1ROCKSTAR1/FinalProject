...
📚 Описание проекта
Продвинутый фреймворк для автоматизированного тестирования с поддержкой веб, API и мобильных приложений. Проект реализует комплексный подход к тестированию с кросс-платформенной поддержкой, интегрирован в CI/CD pipeline и оснащен расширенной системой отчетности.
