...
Фреймворк для автоматизированного тестирования приложения Habatica на всех уровнях: веб-интерфейса через Selenide, REST API через RestAssured и мобильного приложения через Appium. Проект построен на принципах Page Object Model, что обеспечивает чистую архитектуру и легкость поддержки кода.
